export declare type SharingNetwork = 'blogger' | 'delicious' | 'digg' | 'email' | 'facebook' | 'flipboard' | 'google' | 'linkedin' | 'livejournal' | 'mailru' | 'meneame' | 'messenger' | 'oknoklassniki' | 'pinterest' | 'print' | 'reddit' | 'sms' | 'stumbleupon' | 'tumblr' | 'twitter' | 'vk' | 'wechat' | 'weibo' | 'whatsapp' | 'xing';
export declare type FollowNetwork = 'blogger' | 'digg' | 'facebook' | 'flipboard' | 'github' | 'instagram' | 'medium' | 'messenger' | 'linkedin' | 'oknoklassniki' | 'patreon' | 'pinterest' | 'quora' | 'reddit' | 'snapchat' | 'soundcloudm' | 'spotify' | 'telegram' | 'tumblr' | 'twitch' | 'twitter' | 'vk' | 'wechat' | 'weibo' | 'yelp' | 'youtube';
